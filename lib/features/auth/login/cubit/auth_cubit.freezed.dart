...
class __$$LoginInitialImplCopyWithImpl<$Res>
    extends _$AuthStateCopyWithImpl<$Res, _$LoginInitialImpl>
...
abstract class _LoginInitial implements AuthState {
...
abstract class LoginSuccess implements AuthState {
  const factory LoginSuccess({final UserCredential? credential}) =
      _$LoginSuccessImpl;
...
class __$$RegisterInitialImplCopyWithImpl<$Res>
    extends _$AuthStateCopyWithImpl<$Res, _$RegisterInitialImpl>
...
abstract class _RegisterInitial implements AuthState {
...
abstract class RegisterFailure implements AuthState {
...
abstract class LogoutLoading implements AuthState {
...
abstract class LogoutSuccess implements AuthState {
...
abstract class LogoutFailure implements AuthState {
  const factory LogoutFailure(final String message) = _$LogoutFailureImpl;
